...
const PaymentMethods: React.FC = () => {
  ...
  return (
    <section id="payment" className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          {methods.map((method, index) => (
            ...
            >
              <div className={`inline-flex p-3 sm:p-4 rounded-full ${method.color} mb-4 sm:mb-6`}>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <div className="bg-purple-50 rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto">
